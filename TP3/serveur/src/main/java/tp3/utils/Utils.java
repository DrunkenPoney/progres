...
public final class Utils {
	...
	public static InetSocketAddress randomLocalSocket(int minPort, int maxPort) throws SocketException {
		return networkInterfaces()
				...
				.map(ia -> firstAvailableSocketInRange(ia, minPort, maxPort))
